...
def main(argv):
	...
	#usage = filename + ' inputfile -s <schedule> -v <vm window>'
	usage = 'usage: ' + filename + ' inputfile'
...
#	print 'vm window is', vwnd
	...
	# first copy image from template 
	# cp basedir/hadoop.qcow2 vm
